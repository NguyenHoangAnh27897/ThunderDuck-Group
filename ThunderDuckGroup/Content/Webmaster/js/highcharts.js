...
(function(T, K) { "object" === typeof module && module.exports ? module.exports = T.document ? K(T) : K : T.Highcharts = K(T) })("undefined" !== typeof window ? window : this, function(T) {
    ...
    (function(a) {
        ...
        p(F.prototype, {
            ...
            button: function(a, h, b, c, v, f, d, m, I) {
                ...
                k = f.style;
                delete f.style;
                d = E(v, { fill: "#000", style: { color: "#000000", fontWeight: "bold" } }, d);
                q = d.style;
                delete d.style;
    ...
    (function(a) {
        ...
        a.defaultOptions = {
            ...
            chart: { borderRadius: 0, defaultSeriesType: "line", ignoreHiddenSeries: !0, spacing: [10, 10, 15, 10], resetZoomButton: { theme: { zIndex: 6 }, position: { align: "right", x: -10, y: 10 } }, width: null, height: null, borderColor: "#335cad", backgroundColor: "#0E0E26", plotBorderColor: "#cccccc" },
            title: { text: "Chart title", align: "center", margin: 15, widthAdjust: -44 },
            subtitle: { text: "", align: "center", widthAdjust: -44 },
            plotOptions: {},
            labels: { style: { position: "absolute", color: "#ffffff" } },
            legend: {
                enabled: !0,
                align: "center",
                alignColumns: !0,
    ...
    var V = function(a) {
        ...
        a.extend(G.prototype, {
            defaultOptions: {
                ...
                endOnTick: !1,
                labels: { enabled: !0, style: { color: "#fff", cursor: "default", fontSize: "11px" }, x: 0 },
                maxPadding: .01,
                minorTickLength: 2,
    ...
    (function(a) {
        ...
        a.Series = a.seriesType("line", null, {
            ...
            events: {},
            marker: { lineWidth: 0, lineColor: "#ffffff", enabledThreshold: 2, radius: 4, states: { normal: { animation: !0 }, hover: { animation: { duration: 50 }, enabled: !0, radiusPlus: 2, lineWidthPlus: 1 }, select: { fillColor: "#000", lineColor: "#000000", lineWidth: 2 } } },
            point: { events: {} },
